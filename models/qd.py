...
from .base_model import SHealthComponentParamsType, SDistortionParamsType, SCItemQuantumDriveParams, HealthInfo, EntityComponentPowerConnection, EntityComponentHeatConnection
...
class QuantumDrive(UniversalData):

    data: SCItemQuantumDriveParams
...
class QuantumDriveRaw(BaseModel):
    ...
    class Components(BaseModel):
        ...
        SCItemQuantumDriveParams: SCItemQuantumDriveParams
    ...
    def to_quantum_drive(self) -> QuantumDrive:
        ...
        return QuantumDrive(
            ...
            data=self.Components.SCItemQuantumDriveParams,
